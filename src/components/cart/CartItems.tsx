        ...
        return (
          <Box
            ...
            sx={{
              ...
              borderBottom:
                idx < items.length - 1
                  ? (t) => `1px solid ${alpha(t.palette.divider, 0.5)}`
                  : "none",
              transition: "background-color 0.15s ease",
              "&:hover": {
                backgroundColor: (t) => alpha(t.palette.primary.main, 0.02),
              },
            }}
          >
            {/* изображение */}
            <Avatar
              ...
              sx={{
                ...
                flexShrink: 0,
                boxShadow: (t) =>
                  `0 3px 10px ${alpha(t.palette.common.black, 0.1)}`,
              }}
            >
              <Image
                ...
                >
                  ...
                  <Typography
                    sx={{
                      ...
                      fontWeight: 700,
                      border: (t) =>
                        `1px solid ${alpha(t.palette.text.primary, 0.2)}`,
                      borderRadius: "20px",
                      py: 0.4,
                      fontSize: "0.9rem",
                      color: "primary.main",
            ...
            >
              <Typography
                sx={{ fontWeight: 900, fontSize: { xs: 15, sm: 16 } }}
              >
