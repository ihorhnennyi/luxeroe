  ...
  return (
    <Box
      ...
      sx={{
        ...
        background:
          "linear-gradient(140deg,#E9B15E 0%,#D87D3D 60%,#B75C36 100%)",
                  ...
                  >
                    <Box
                      ...
                      sx={{
                        ...
                        borderRadius: "50% 40% 60% 50% / 50% 50% 40% 60%",
                        background:
                          "linear-gradient(145deg,#E9B15E 0%,#D87D3D 90%)",
          ...
          <Box sx={{ flex: 1, position: "relative", width: "100%" }}>
            <Box
              sx={{
                ...
                boxShadow: (t) =>
                  `0 16px 50px ${alpha(t.palette.common.black, 0.12)}`,
              }}
            >
              <Image
              ...
              />
              {typeof price === "number" && (
                <PriceBadge price={price} note={priceNote} />
              )}
            </Box>
          </Box>
        </Stack>
